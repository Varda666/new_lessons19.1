...
<div class="container">
        <header>
            <div class="pricing-header p-3 pb-md-1 mx-auto text-center">
                <p class="fs-5 text-body-secondary">раздел FAQ</p>
            </div>
        </header>
        <main>
            <div class="dropup">
                <div class="mt-2 mb-2">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#">Для каждой из кнопок сделайте выпадающий блок с текстом,
                    текст можно заполнить любой.</a></li>
                  </ul>
                </div>
            </div>
            <div class="dropup">
